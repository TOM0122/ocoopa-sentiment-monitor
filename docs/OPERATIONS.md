...
- **公开社媒发现**每小时:Brave 站点限定查询补充公开 TK / IG / FB / YouTube / X / Reddit / 论坛 / 评论页；另有已知新闻媒体 Facebook 账号的定向索引查询每 4 小时运行一次。两者合计约 30 次/天，保持免费配额；每个新公开索引源的首次成功采集均静默入库，避免把索引存量当作实时新舆情推送。
